...
function init(doc) {
    if (status === 'ready')
        return;
    var weappsStyle = doc.createElement('style');
...
function hideToast(options) {
    ...
    var errMsg = 'hideToast:ok';
    options.success && options.success({ errMsg: errMsg });
    options.complete && options.complete({ errMsg: errMsg });
}
