...
var downloadFile = function (_a) {
    var url = _a.url, filePath = _a.filePath, header = _a.header, timeout = _a.timeout, success = _a.success, fail = _a.fail, complete = _a.complete;
    var task = {};
