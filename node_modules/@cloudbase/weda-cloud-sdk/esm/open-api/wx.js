...
export const WxRequest = async (path, options) => {
    var _a;
    const copyOptions = Object.assign(Object.assign({}, options), { method: options.method || 'POST', body: typeof options.body === 'string'
            ...
            }), headers: Object.assign(Object.assign({}, options.headers), { 'x-request-id': ((_a = options.headers) === null || _a === void 0 ? void 0 : _a['x-request-id']) || UUID.uuid(), host: `${options.envId}.ap-shanghai.tcb-api.tencentcloudapi.com` }) });
...
export async function processBaseRequestOptions(options) {
