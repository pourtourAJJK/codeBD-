...
const getExternalAdapter = async () => {
    const __asyncRequire__ = (0, common_1.getConfig)('__asyncRequire__');
    try {
...
const getBaseWxRequestClass = async () => {
    ...
    if (!(externalAdapter === null || externalAdapter === void 0 ? void 0 : externalAdapter.WxRequest))
        return adapter_interface_1.AbstractSDKRequest;
...
async function genAdapterAsync() {
        ...
        post(options) {
            ...
            return new Promise((resolve, reject) => {
                ...
                const task = wx.request({
                    url: (0, adapter_interface_1.formatUrl)('https:', url),
                    data,
    ...
    const adapter = {
        ...
        localStorage: storage_1.wxMpStorage,
