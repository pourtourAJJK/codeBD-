...
async function signIn(params) {
    // 避免重复调用登录接口
    // if (observedInfo.currentUser && !params.force) return observedInfo.currentUser;
    let userInfo = await (0, cache_1.dealCache)({
        key: 'SIGNIN_INFO',
        type: 'get',
    });
    if (params.force || !userInfo) {
        userInfo = await callSignInWithCache(params);
    }
    else {
        callSignInWithCache(params);
    }
...
const Anonymous_signIn_res = { wxUnionId: '', name: 'Anonymous' };
async function callSignInWithCache(params) {
    const { app } = await (0, tcb_1.getTcbInstance)();
    const loginState = await (0, tcb_1.getLoginState)();
    let accessToken = '';
    try {
        const res = await (0, tcb_auth_1.getAccessToken)();
        accessToken = res === null || res === void 0 ? void 0 : res.accessToken;
    }
    catch (e) { }
    const { meta = {} } = (0, cache_2.parseWedaAccessToken)(accessToken);
    let callPromise = (0, cloud_api_1.callCommonService)({
        /**
         * @deprecated
         * 疑似废弃，无主调传入该数据
         */
        ...
        return processSignInRes(Object.assign({}, wedaInfo, params, {
            lastUpdateTime: Date.now(),
        }), meta === null || meta === void 0 ? void 0 : meta.wxOpenId);
    });
    if (loginState.isAnonymous && accessToken) {
        let wedaInfo = Object.assign(Object.assign({}, Anonymous_signIn_res), { wxUnionId: Anonymous_signIn_res.wxUnionId || (meta === null || meta === void 0 ? void 0 : meta.wxUnionId) || '' });
        return processSignInRes(Object.assign({}, wedaInfo, params, {
            lastUpdateTime: Date.now(),
        }), meta === null || meta === void 0 ? void 0 : meta.wxOpenId);
    }
...
async function processSignInRes(wedaInfo, defaultWxOpenId) {
    const { app } = await (0, tcb_1.getTcbInstance)();
    const userInfo = Object.assign({}, wedaInfo, {
        lastUpdateTime: Date.now(),
    });
    ...
    if (!userInfo.wxOpenId) {
        ...
        let getWxContextPromise = (0, cloud_api_1.callCommonService)({
            ...
            if ((_a = res.Data) === null || _a === void 0 ? void 0 : _a.Data) {
                wx.setStorageSync('wd-GetWxContext', (_b = res.Data) === null || _b === void 0 ? void 0 : _b.Data);
            }
            return (_c = res.Data) === null || _c === void 0 ? void 0 : _c.Data;
        });
        try {
            let wxOpenId;
            if (!Data) {
                if (defaultWxOpenId) {
                    wxOpenId = defaultWxOpenId;
                }
                else {
            ...
            if (!wxOpenId) {
                ...
                wxOpenId = (WXContext === null || WXContext === void 0 ? void 0 : WXContext.FROM_OPENID) || (WXContext === null || WXContext === void 0 ? void 0 : WXContext.OPENID);
            }
    ...
    // 使用TOKEN解析到的openid优先级更高
    userInfo.wxOpenId = defaultWxOpenId || userInfo.wxOpenId;
    (0, cache_1.dealCache)({
        key: 'SIGNIN_INFO',
        value: userInfo,
        type: 'set',
...
async function openIdLoginInWxApp() {
    ...
    await signIn({ userType: 'externalUser', providerId });
    return res;
}
/**
 * 小程序unionId静默登录
        ...
        wx.login({
            success: async (res) => {
                ...
                try {
                    ...
                    await signIn({ userType: 'externalUser' });
                    resolve(true);
                }
                catch (error) {
