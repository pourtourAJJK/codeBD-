...
export async function signOut(options = {}) {
    ...
    if (options?.isRefresh) {
        ...
        setTimeout(() => {
            try {
                // 小程序端退出登录后需要用以下方法重启小程序，方法参考https://developers.weixin.qq.com/miniprogram/dev/api/navigate/wx.restartMiniProgram.html
...
export async function getUserInfoFromCloudSDK(force = false) {
    try {
        ...
        wxOpenId = wedaUser?.wxOpenId || wxContext?.FROM_OPENID || wxContext?.OPENID;
