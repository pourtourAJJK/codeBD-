import { getDatapatch } from '../../../src/mp/runtime/data-patch';
...
describe('test src/mp/runtime/data-patch', () => {
  for (const c of cases) {
    it(`test data-patch ${c.desc}`, () => {
      expect(getDatapatch(c.base, c.data)).toEqual(c.patch);
    });
  }
});
