...
class Query {
    ...
    #paramsRef = (0, mobx_1.observable)({ current: null });
    #currentRequestKey = null;
    #observableValue = (0, mobx_1.observable)({ data: null, error: null, isFetching: false });
    #eventHandlerMap = {};
    ...
    constructor({ schema, context, options = {}, }) {
        ...
        if (this.#schema?.trigger === 'auto') {
            this.#disposes.push((0, mobx_1.autorun)((r) => {
                try {
        ...
        this.#eventHandlerMap = Object.entries((0, util_1.createEventHandlers)(this.#schema.eventHandlers || {}, {
    ...
    #resolveParams(additionalScope = {}, options = {}) {
         ...
         * 从而导致 autorun 没有添加依赖
         */
        let { params = [] } = (0, util_1.mergeDynamic2StaticData)((0, mobx_1.toJS)(this.#paramsRef.current), this.#dataBinds, {
            $w: this.#context.$w,
    ...
    async #emit(eventName, data) {
        return this.#eventHandlerMap[(0, util_1.getMpEventHandlerName)(this.id, eventName)]?.(new event_emitter_1.Event({
            type: eventName,
            detail: data,
            target: undefined,
