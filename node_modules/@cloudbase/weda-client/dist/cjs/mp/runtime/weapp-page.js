...
exports.createSimplePageAPIFromLaunchOptions = exports.createPage = exports.PAGE_ROOT_SYMBOL = void 0;
                    ...
                    pageStyle: () => {
                        ...
                        try {
                            if (pageRootDataBinds.style) {
                                ...
                                pageStyle = {
                                    ...pageStyle,
                                    ...(typeof style === 'string' ? (0, style_1.style2CssProperties)(style) : style),
                                };
                            }
                        }
                        catch (e) {
...
async function createSimplePageAPIFromLaunchOptions() {
    const options = (await index_2.APP_LAUNCH_OPTIONS_PROMISE) || {};
...
exports.createSimplePageAPIFromLaunchOptions = createSimplePageAPIFromLaunchOptions;
