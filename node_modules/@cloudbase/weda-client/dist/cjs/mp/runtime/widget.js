...
exports.generateWidgetAPIContext = exports.createInitData = exports.disposeWidget = exports.getWidget = exports.ID_SEPARATOR = exports.generateForContextOfWidget = exports.createWidget = exports.createWidgets = exports.resolveWidgetData = void 0;
...
function resolveWidgetProp(props, widgetId) {
    ...
    _staticResourceAttribute?.forEach?.((property) => {
        (0, util_1.processStaticResourceAttribute)(data, undefined, property);
    });
    return data;
}
// widget prop -> wxml data
function resolveWidgetData(props, widgetId) {
...
function createWidgets(widgetProps, dataBinds, ownerMpInst, widgetHolder) {
 ...
 */
function createSubWidgetTree(ctx, curForNode, dataBinds, ownerMpInst, forContext = {}, failedBinds = [], parentWidget = { children: (0, mobx_1.observable)([]), _disposers: [] }, widgetHolder = {}) {
...
function runFor(curForNode, dataBinds, ownerMpInst, forContext, ownerForWidgetHolder, failedBinds, parentWidget) {
    ...
    const dispose = (0, mobx_1.autorun)(() => {
        ...
        try {
            ...
            const $w = (0, mobx_1.untracked)(() => generateWidgetAPIContext($instance?.__internal__?.$w, parentWidget, forContext));
        ...
        (0, mobx_1.untracked)(() => {
            ...
            forWidgets.forEach((widget, index) => {
                ...
                if (exsitMap[cecheKey] !== undefined) {
                    const nodeId = widget.id?.split(exports.ID_SEPARATOR)[0];
...
function createWidget(props, nodeId, indexPostfix, parent, ownerMpInst, forContext) {
    ...
    Object.defineProperty(w, '_instanceRef', { value: (0, mobx_1.observable)({ current: null }) });
    if (parent) {
        // w.parent = parent
    ...
    if (isRepeaterWidget(w, REPEATER.REPEATER_NAME)) {
        ...
        // 默认初始值
        w._disposers.push((0, mobx_1.autorun)((r) => {
            const ref = {
                data: w.data,
                items: w.items,
            };
        ...
        const setUpDataBind = (isFinalTry = false) => {
            ...
            const dispose = (0, mobx_1.autorun)((reaction) => {
                try {
                    ...
                    const $w = (0, mobx_1.untracked)(() => generateWidgetAPIContext(ctx?.__internal__?.$w, w, forContext));
                    ...
                    if (paths.length > 1) {
                        // 一定要 untracked 不然爆栈了
                        (0, mobx_1.untracked)(() => (0, vender_1.set)(w, prop, value));
                    }
                    else {
                        // 普通 key 直接赋值
                        w[prop] = value;
...
function mountBuiltinWigetsAPI(widget, owner) {
    ...
    widget.getConfig = () => ({});
    const lowcode = util_1.compLowcodes[widget.widgetType];
    if (lowcode) {
...
class UserWidget {
  ...
  `;
    ...
    get custom() {
        const widget = this._widget;
        const userCustomMember = (0, mobx_1.untracked)(() => {
