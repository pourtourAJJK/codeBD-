...
exports.getDatapatch = void 0;
const util_1 = require("./util");
function getDatapatch(base, pendingData) {
    const patch = {};
...
exports.getDatapatch = getDatapatch;
    ...
    if (Array.isArray(pendingWidget)) {
        ...
        const differentProps = allProps.filter((prop) => {
            ...
            if (prop === 'data' &&
                ...
                (0, util_1.deepEqual)(pendingWidget[prop], baseWidget[prop])) {
                return false;
            }
