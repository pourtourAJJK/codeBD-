...
exports.ENV_TYPE = exports.NETWORK_TYPE = exports.USERINFO_TYPE = exports.EXTERNAL_USERINFO_WHITELIST = exports.RELATEDROLES_WHITELIST = exports.INNER_USERINFO_WHITELIST = exports.LINK_PROTOCOL = exports.ROUTER_KEY = exports.ACTIONS_KEY = exports.EPLATFORM = void 0;
/**
 * 平台：web、小程序
 */
var EPLATFORM;
...
})(ACTIONS_KEY = exports.ACTIONS_KEY || (exports.ACTIONS_KEY = {}));
/**
 * @description 路由key
 * @private _前缀的都是内部方法，有可能调整，不推荐外部用户使用
 */
...
})(ROUTER_KEY = exports.ROUTER_KEY || (exports.ROUTER_KEY = {}));
/**
 * @description 链接跳转协议
 * @private
 */
...
})(LINK_PROTOCOL = exports.LINK_PROTOCOL || (exports.LINK_PROTOCOL = {}));
/**
 * 内部用户对外开放字段
 */
exports.INNER_USERINFO_WHITELIST = [
    'name',
    'openId',
    'type',
    'userId',
...
exports.RELATEDROLES_WHITELIST = ['envId', 'id', 'name', 'roleIdentity'];
/**
 * 外部用户对外开放字段。比内部用户少了name
 */
exports.EXTERNAL_USERINFO_WHITELIST = [
    'type',
    'openId',
    'userId',
    'relatedRoles',
