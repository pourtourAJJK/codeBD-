...
function generateMethodsFrom$w($w) {
...
exports.generateMethodsFrom$w = generateMethodsFrom$w;
function patchDeprecatedSetStateVar($w, varPath, value) {
    const [scope, varName] = varPath.split('.');
    if (scope === '$page') {
...
exports.patchDeprecatedSetStateVar = patchDeprecatedSetStateVar;
...
exports.APP_LAUNCH_OPTIONS_PROMISE = new ControlledPromise();
