...
exports.Rand = exports.Sum = exports.Round = exports.Ceiling = exports.Floor = exports.Average = exports.Max = exports.Min = exports.ABS = void 0;
 ...
 */
function ABS(num) {
    return vender_1.Decimal.abs(num).toNumber();
}
exports.ABS = ABS;
/**
 * 最小值
 ...
 */
function Min(...args) {
    return vender_1.Decimal.min(...args).toNumber();
}
exports.Min = Min;
/**
 * 最大值
 ...
 */
function Max(...args) {
    return vender_1.Decimal.max(...args).toNumber();
}
exports.Max = Max;
/**
 * 平均值
...
function Average(...args) {
    ...
    try {
        args.forEach((i) => {
            sum = vender_1.Decimal.add(sum, i).toNumber();
            val = vender_1.Decimal.div(sum, args.length).toNumber();
        });
    }
    catch (e) {
        throw e;
 ...
 */
function Floor(num) {
    return vender_1.Decimal.floor(num).toNumber();
}
exports.Floor = Floor;
/**
 * 向上取整
...
function Ceiling(num) {
    return vender_1.Decimal.ceil(num).toNumber();
}
 ...
 */
function Round(num) {
    return vender_1.Decimal.round(num).toNumber();
}
exports.Round = Round;
/**
 * 求和
 ...
 */
function Rand(num) {
    return vender_1.Decimal.floor(vender_1.Decimal.mul(vender_1.Decimal.random(20), num)).toNumber();
}
exports.Rand = Rand;
