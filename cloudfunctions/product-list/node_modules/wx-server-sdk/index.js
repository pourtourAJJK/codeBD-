...
exports.TCB_ERR_CODE = {
    ...
    // 数据�?    DATABASE_REQUEST_FAILED: -502001,
    ...
    // 云函�?    FUNCTIONS_REQUEST_FAIL: -504001,
...
exports.ERR_CODE = {
    ...
    // �?6 开始的是由微信服务器侧产生的错误码
    // �?5 开始的是由腾讯云侧产生的错误码
    // �?4 开始的是本�?SDK 产生的错�?    // 接下来两位表示具体业务类型：01通用�?2数据库，03文件�?4云函�?    // 最后三位表示具体的错误
    // 小程�?SDK 云函�?    '-404001': 'empty call result',
    ...
    // 腾讯云文件管�?    '-503001': 'storage request fail',
